 ...
 Зрозумів, ми залишаємо **тільки синхронну взаємодію через HTTP/gRPC** і прості черги всередині сервісів без Kafka чи будь-яких зовнішніх брокерів. Ось готова версія лабораторної роботи №3:
